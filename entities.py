...
ground = Entity(model='plane', scale=32, texture='earth_map', texture_scale=(32, 32), collider='box', position=Vec3(0, 0, 0))
...
gun = Entity(model='gun_lp.blend', scale=1, collider='gun_lp.blend', position=Vec3(0, 10, 0), color=color.light_gray, texture='gun_lp_occlusion')
