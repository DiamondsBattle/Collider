...
class HealthBar(Button):
    ...
    def __init__(self, max_value=50, show_text=True, show_lines=False, **kwargs):
        super().__init__(
    ...
    def __setattr__(self, name, value):
        ...
        if 'scale' in name and hasattr(self, 'roundness'):
        ...
        if 'scale' in name and hasattr(self, 'text_entity'):
